...
{
    public sealed class Gost2012_512_KeyValue:KeyInfoClause
    {
        #region Constructor

        public Gost2012_512_KeyValue()
        {
            Key = new Gost3410_2012_512_AsymmetricAlgorithm();
        }

        public Gost2012_512_KeyValue(AsymmetricAlgorithm key)
        {
            Key = key;
        }
