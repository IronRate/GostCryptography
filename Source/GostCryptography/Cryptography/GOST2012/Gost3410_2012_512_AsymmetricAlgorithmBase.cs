...
{
    public abstract class Gost3410_2012_512_AsymmetricAlgorithmBase:AsymmetricAlgorithm
    {
        /// <summary>
		/// Наименование алгоритма цифровой подписи по ГОСТ Р 34.10.
		/// </summary>
		public const string Gost3410_2012_512_SignatureAlgorithm = "urn:ietf:params:xml:ns:cpxmlsec:algorithms:gostr34102012-gostr34112012-512";

        /// <summary>
        /// Наименование алгоритма обмена ключами по ГОСТ Р 34.10.
        /// </summary>
        public const string Gost3410_2012_512_KeyExchangeAlgorithm = "urn:ietf:params:xml:ns:cpxmlsec:algorithms:transport-gost2012-512";
        ...
        {
            get { return Gost3410_2012_512_SignatureAlgorithm; }
        }
        ...
        {
            get { return Gost3410_2012_512_KeyExchangeAlgorithm; }
        }
